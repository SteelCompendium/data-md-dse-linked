      ...
      - type: feature
        ...
        effects:
          ...
          - roll: Power Roll + Agility
            ...
            tier2: The creature can [fly](REL_PATH_PREFIXRules/Movement/FlyREL_PATH_SUFFIX)
        ...
        effects:
          ...
          - name: Effect
            effect: You choose the new targets for the original target's [free
              strike](REL_PATH_PREFIXRules/Abilities/Common/Main%20Actions/Free%20StrikeREL_PATH_SUFFIX)
              or ability. Additionally, if you are hidden or disguised, using
              this ability doesn't cause you to be revealed.
```
...
effects:
  - effect: |-
      Choose one of your domains. You gain a heroic ability from that domain, as shown on the 9th-Level [Conduit](REL_PATH_PREFIXRules/Classes/ConduitREL_PATH_SUFFIX) Domain Abilities table.
    ...
    features:
        ...
        effects:
          - name: Effect
            effect: You can target yourself instead of one ally with this ability. Each
              ...
              their turn, and can stand up if they are
      ...
      - type: feature
        ...
        effects:
          - roll: Power Roll + Intuition
            tier1: 10 + I damage; A < WEAK,
              [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX)
              (save ends)
            tier2: 15 + I damage; A < AVERAGE,
              [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX)
              (save ends)
            tier3: 21 + I damage; A < STRONG,
              [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX)
              (save ends)
          - name: Effect
            effect: While
              [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX)
              this way, the target takes 10 damage at the start of each of your
              turns.
      - type: feature
        feature_type: ability

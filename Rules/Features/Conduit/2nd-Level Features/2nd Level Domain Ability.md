...
effects:
  - effect: |-
      Choose one of your domains. You gain a heroic ability from that domain, as shown on the 2nd-Level [Conduit](REL_PATH_PREFIXRules/Classes/ConduitREL_PATH_SUFFIX) Domain Abilities table.
        ...
        effects:
          - roll: Power Roll + Intuition
            tier1: 2 damage; A < WEAK,
              ...
              (save ends)
            tier2: 3 damage; A < AVERAGE,
              [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX)
              (save ends)
            tier3: 7 damage; A < STRONG,
              [restrained](REL_PATH_PREFIXRules/Conditions/RestrainedREL_PATH_SUFFIX)
              (save ends)
      - type: feature
        feature_type: ability

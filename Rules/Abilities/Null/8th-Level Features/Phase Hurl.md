...
effects:
  - roll: Power Roll + Agility
    tier1: 9 + A damage; push 5; I < WEAK,
      [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
    tier2: 13 + A damage; push 7; I < AVERAGE,
      [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
    tier3: 18 + A damage; push 10; I < STRONG,
      [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) (save ends)
  - name: Effect
    effect: The target and each creature or object they collide with from this
      ...
      the target was force moved. While the target is
      [dazed](REL_PATH_PREFIXRules/Conditions/DazedREL_PATH_SUFFIX) this way,
      they see glimpses of creatures from other parts of the timescape.
```
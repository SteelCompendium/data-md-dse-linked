...
effects:
  - name: Effect
    effect: >-
      ...
      mark on a creature (no action required), and if another
      [tactician](REL_PATH_PREFIXRules/Classes/TacticianREL_PATH_SUFFIX) marks a
      ...
      abilities allow you to mark additional creatures at the same time. The
      mastermind tactical doctrine's Anticipation feature allows you to target
      additional creatures with this ability starting at 5th level.

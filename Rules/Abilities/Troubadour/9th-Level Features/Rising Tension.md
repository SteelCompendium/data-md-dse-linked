...
effects:
  - name: Effect
    effect: The target gains 3 of their Heroic Resource, has a double edge on a
      ...
      [weakened](REL_PATH_PREFIXRules/Conditions/WeakenedREL_PATH_SUFFIX) if
      they were before, and can immediately take their turn after yours if they
      have not taken their turn already this round.
```
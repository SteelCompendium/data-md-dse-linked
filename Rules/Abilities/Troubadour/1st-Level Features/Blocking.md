...
effects:
  - name: Effect
    effect: At the end of each of your turns while this performance is active, you
      ...
      [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) those
      targets to unoccupied spaces in the area. A target can't be
      [teleported](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) in a
      way that would harm them (such as over a cliff), leave them dying, or

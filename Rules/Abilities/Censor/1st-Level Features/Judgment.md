...
effects:
  - name: Effect
    effect: |-
      The target is judged by you until the end of the encounter, you use this ability again, you willingly end this effect (no action required), or another [censor](%7BREL_PATH_PREFIX%7DRules/Classes/Censor%7BREL_PATH_SUFFIX%7D) judges the target.

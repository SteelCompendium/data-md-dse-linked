...
effects:
  - name: Effect
    effect: >-
      ...
      creature can choose to be instantly
      [teleported](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) to an
      unoccupied space of their choice adjacent to the other portal. If an enemy
      is force moved into a portal, their forced movement ends and they emerge
      from the other portal in an unoccupied space chosen by the creature who
      force moved them.

...
effects:
  - name: Effect
    effect: >-
      ...
      - You [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) up
      to a number of squares equal to your Reason score. If you choose this
      option, you can spend essence to
      [teleport](REL_PATH_PREFIXRules/Movement/TeleportREL_PATH_SUFFIX) 1
      additional square for each essence spent.
```
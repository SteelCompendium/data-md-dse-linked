...
effects:
  - name: Effect
    effect: You create a size 1L vortex that lasts until the end of the encounter.
      ...
      vortex [vertical](REL_PATH_PREFIXRules/Movement/VerticalREL_PATH_SUFFIX)
      pulls 3 each enemy within 5 squares of it. Each enemy who enters the
      vortex or starts their turn there is knocked
      [prone](REL_PATH_PREFIXRules/Conditions/ProneREL_PATH_SUFFIX). At the end
